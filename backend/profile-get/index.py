...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    cursor.execute(f"SELECT id, email, full_name, last_name, middle_name, birth_date, fsr_id, education_institution, coach, city_country, representative_phone, is_verified, created_at, is_admin FROM users WHERE id = {user_id}")
